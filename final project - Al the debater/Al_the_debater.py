...
async def artwork(ctx):
    ...
    try :
        ...
        try :
            giphy_api_response = giphy_API_instance.gifs_search_get(giphy_API_key, wikipedia_research_art, limit=5)
...
async def movie(ctx):
    ...
    try :
        ...
        try :
            giphy_api_response = giphy_API_instance.gifs_search_get(giphy_API_key, wikipedia_research_movie, limit=5)
            movie_gif_list = list(giphy_api_response.data)
            Movie_gif = random.choice(movie_gif_list)
